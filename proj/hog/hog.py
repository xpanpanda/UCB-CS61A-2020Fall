...
def free_bacon(score):
    ...
    if score==0:
        return 6
    return (pi//pow(10,101-score-1))%10+3
    # END PROBLEM 2
...
def swine_align(player_score, opponent_score):
    ...
    """
    # BEGIN PROBLEM 4a
    score=min(player_score,opponent_score)
    GCD=0
...
def pig_pass(player_score, opponent_score):
    ...
    """
    # BEGIN PROBLEM 4b
    return opponent_score-3<player_score<opponent_score
    # END PROBLEM 4b
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    # BEGIN PROBLEM 7
    def announce(score0,score1,last=last_score,high=running_high):
        if who==1:
            if (score1-last)>high:
                high=score1-last
            ...
            if (score0-last)>high:
                ...
                print(high,'point(s)!','The most yet for Player',who)
            last=score0
        return announce_highest(who,last_score=last,running_high=high)
    return announce
...
def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    ...
    lowest_index=0
    for i in range(1,11):
        average_num=make_averaged(roll_dice,trials_count)(i,dice)
        if average_num>average_max:
            average_max=average_num
            index=i
    return index
    # END PROBLEM 9
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    """
    # BEGIN PROBLEM 12
    if score>opponent_score and score<=90:
